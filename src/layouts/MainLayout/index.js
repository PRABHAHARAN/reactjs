...
import { AddProducts,ProductCategory,ProductSubCategory,PackingType,Unit,MaterialTableDemo} from "./../../pages";
    ...
    return (
      ...
      <div className={classes.root}>
        ...
        >
          ...
          <NavLink activeOnlyWhenExact to="/" icon={HelpIcon}>
           Add Products
         </NavLink>
          
          <NavLink to="/ProductCategory" icon={HelpIcon} >
            Product Category
          </NavLink>
          <NavLink to="/ProductSubCategory" icon={HelpIcon} >
            Product Sub Category
          </NavLink>
          <NavLink to="/PackingType" icon={HelpIcon}>
            Packing Type
          </NavLink>
          <NavLink to="/Unit" icon={HelpIcon} >
            Unit
          </NavLink>
          <NavLink to="/Table" icon={HelpIcon} >
            Table
          </NavLink>
